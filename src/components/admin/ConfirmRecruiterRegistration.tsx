...
export default function ConfirmRecruiterRegistration({ url, onClose, userId, userEmail, registrationId }: ConfirmRecruiterRegistrationProps) {
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl overflow-hidden flex flex-col max-h-[95vh]">
                ...
                <div className="flex flex-col md:flex-row overflow-hidden h-full">
                    ...
                    <div className="w-full md:w-96 p-6 overflow-y-auto space-y-4 bg-white">
                        <h4 className="font-bold text-sm text-gray-500 uppercase tracking-wider">Thông tin từ AI</h4>
                        ...
                        {loading && (
                            <div className="p-4 bg-blue-50 border border-blue-100 rounded-xl">
                                <div className="flex items-center gap-3 mb-2">
                                    ...
                                    <span className="text-sm font-bold text-blue-700">Đang quét dữ liệu ({progress}%)</span>
                                </div>
                        ...
                        <div className="space-y-3">
                            <div>
                                <label className="text-xs font-bold text-gray-500">Tên công ty</label>
                                <input
                                    ...
                                    onChange={(e) => setOcrData({ ...ocrData, companyName: e.target.value })}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setOcrData({ ...ocrData, taxCode: e.target.value })}
                                    placeholder={loading ? "Đang đọc..." : "Chưa có dữ liệu"}
                                />
                            </div>
                            <div>
                                <label className="text-xs font-bold text-gray-500">Địa chỉ trụ sở</label>
                                <textarea
                        ...
                        {ocrData.rawText && !loading && (
                            <div className="pt-2">
                                <label className="text-[10px] font-bold text-gray-400 uppercase tracking-tighter">Dữ liệu thô từ Tesseract</label>
