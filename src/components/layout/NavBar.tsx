    ...
    <>
      <nav className="flex items-center justify-between px-10 py-4 bg-white shadow-sm font-sans">
        ...
        <div className="flex items-center cursor-pointer" onClick={() => navigate('/')}>
          ...
          <span className="text-2xl font-bold text-gray-800">ob</span>
        </div>
        ...
        {!currentUser&& (
          ...
          <button className="text-gray-800 font-semibold hover:text-blue-600 transition-colors underline decoration-2 underline-offset-4"
            onClick={handleRegister}
          >
            Đăng ký
          </button>
          <button className="bg-[#3498db] text-white px-8 py-2.5 rounded-full font-semibold hover:bg-blue-500 transition-all shadow-md"
            onClick={handleLogin}
          >
            Đăng nhập
          </button>
